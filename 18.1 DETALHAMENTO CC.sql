USE HUBDADOS; --DETALHAMENTO DO CENTRO DE CUSTO
...
, LANCAMENTOS AS (
SELECT A.IDMOV, A.IDLAN, B.DESCFORMAPAGTO, A.DESCSTATUSLCTO, A.CODCFO, A.DATAVENCIMENTO, A.DATABAIXA FROM CorporeRM.FLAN A
